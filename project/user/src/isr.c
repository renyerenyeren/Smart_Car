...
void pit_handler_0(void); //读取速度 & 灰度传感器读数
void pit_handler_1(void); //读取陀螺仪
void pit_handler_2(void); //总钻风图像
void pit_handler_3(void); //用于判断的中断

void my_uart_callback(uart_index_enum uart_n); //串口回调函数
